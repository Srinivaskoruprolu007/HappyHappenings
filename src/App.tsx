  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-grow">
        ...
        {/* Featured Events */}
        <section id="events" className="py-20 bg-background dark:bg-background-dark">
        ...
        <section id="about" className="py-20 bg-background dark:bg-background-dark">
          <div className="container mx-auto px-4">
            <FadeIn>
              <h2 className="text-3xl font-bold mb-8 text-center text-foreground">About Us</h2>
              <div className="max-w-3xl mx-auto text-center">
                <p className="text-lg text-muted-foreground dark:text-muted-dark">
                  HappyHappening brings you the most exciting music events and concerts.
                  We curate unforgettable experiences that connect artists with their fans
                  in spectacular venues across the city.
                </p>
              </div>
            </FadeIn>
          </div>
